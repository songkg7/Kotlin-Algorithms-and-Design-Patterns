...
internal class KnuthMorrisPrattTest {
    ...
    fun test() {
        ...
        assertEquals(
            3,
            knuthMorrisPratt.count(
                "the",
                "Watch the Keynote, livestream replay, and tech talks to hear about the latest updates in Android development directly from the Android team."
            )
        )
        assertEquals(
            0,
